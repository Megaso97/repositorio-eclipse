...
public class SegundaVentana extends JFrame {
	...
	public SegundaVentana() {
		setTitle("Alumnos/");
		setIconImage(Toolkit.getDefaultToolkit().getImage(SegundaVentana.class.getResource("/imagenes/UE_Logo_Positive_RGB_8886cecf-afc9-4280-aa69-8615676d1d03_1513x-2-e1635163959405.png")));}
